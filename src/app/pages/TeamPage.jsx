...
function Executive (props){
  ...
  var executives = chunk(props.executives,2);
          ...
          executives.map((executiveRow) => (
            <Row>
              {executiveRow.map(executive => (
                  <Col md={6}>
                  <img src={executive.imagePath} className="img-circle wow fadeInDown"/>
...
function Advisors (props){
  ...
  var advisors = chunk(props.advisors,2); //This devides the advisors into 2 segments to be able to be displayed on the 
            ...
            advisors.map((advisorRow) => (
              <Row>
                {advisorRow.map(advisor => (
                    <Col md={6}>
                    <img src={advisor.imagePath} className="img-circle wow fadeInDown"/>
  ...
  const executives = [
    {
      ...
      imagePath:"/assets/img/Megan.jpg",
    ...
    },
    {
      name:"HASNAIEN AHMED",
      position:"CO-PRESIDENT",
      imagePath:"/assets/img/Hasnaien.jpg",
    ...
    },
    {
      ...
      imagePath:"/assets/img/Kourosh.jpg",
    ...
    },
    {
      ...
      imagePath:"/assets/img/Uriel.JPG",
    ...
    },
    {
      ...
      imagePath:"/assets/img/Kaitlyn.jpg",
    ...
    },
    {
      ...
      imagePath:"/assets/img/Janna.JPG",
    ...
    },
    {
      ...
      imagePath:"/assets/img/Jackie.JPG",
    ...
    },
    {
      ...
      imagePath:"/assets/img/Monica.JPG",
    ...
    },
    {
      ...
      imagePath:"/assets/img/Suman.jpg",
  ...
  const advisors =[
    {
      ...
      imagePath:"/assets/img/Yassine.jpg",
    ...
    {
      name:"ABDULLAH AZEEM",
      imagePath:"/assets/img/Abdullah.JPG",
