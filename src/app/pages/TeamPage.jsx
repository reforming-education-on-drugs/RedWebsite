            ...
            <Row>
              {
                executiveRow.map(executive => (
                  <Col md={6}>
                    <img src={executive.imagePath} className="img-circle wow fadeInDown" alt={executive.name} />
              ...
              <Row>
                {
                  advisorRow.map(advisor => (
                    <Col md={6}>
                      <img src={advisor.imagePath} className="img-circle wow fadeInDown" alt={advisor.name} />
