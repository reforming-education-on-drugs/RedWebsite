  ...
  if (hiring) {
    return (
      <div>
        ...
        <p>Regular work with members to provide event updates and posting on various social media websites, and our official websites and support VP IT in leading the development of promotional materials. Contact <a className="whitebackground" href="mailto:kourosh.banaeianzade@ucalgary.ca">kourosh.banaeianzade@ucalgary.ca</a> with your cv/resume if interested. Please also send a summary detailing why you want to join the club and why you are a great fit for the position in your email.</p>

        <h3>Jr. VP-Education Coordinator (2 Positions)</h3>
        <p>Regularly work with members and Director of Education to train and prepare presenting members of RED presentations through leading presentation practice sessions, and organization/management of presenting schedule (who will present with whom, on which date, at which time, etc.) Contact <a className="whitebackground" href="mailto:mtsleung@ucalgary.ca">mtsleung@ucalgary.ca</a> with your cv/resume if interested. Please also send a summary detailing why you want to join the club and why you are a great fit for the position in your email.</p>

        <h3>Jr. VP-Sponsorships (1 position) </h3>
        <p>Work with Vp Finance and members on the Team Fund to assist and lead in the acquisition of funds and organization of fundraising events. Such responsibilities include coordinating schedules, meeting prospective industry partners and organizations, as well as seeking novel opportunities to secure funds. Contact <a className="whitebackground" href="nilesh.sharma@ucalgary.ca">nilesh.sharma@ucalgary.ca</a> with your cv/resume if interested. Please also send a summary detailing why you want to join the club and why you are a great fit for the position in your email.</p>
