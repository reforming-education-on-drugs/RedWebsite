    ...
    return (
      <main>
        ...
        <div className="container greycontainer">
          <form name="contactform" method="post" onSubmit={this.handleSubmit} action="send_form_email.php">
            <br style={{ clear: "both" }} />
            ...
            <Button className="pull-right" type="submit" id="submit" value="Submit" name="submit">Send</Button>
          </form>
          {
