    ...
    <main>
      ...
      <div className="container redcontainer">
        ...
        <p>
          ...
          providing them with accurate information about the biological effects
          of drugs. What sets us apart is our science-based, unbiased approach
          to substance use education. We have found this method to foster an
          environment of trust in which students feel comfortable participating
          in open discussion. Our educational workshops are tailored to junior
          high and high school students that are exposed to relevant topics in
          Alberta such as fentanyl and cannabis.
        </p>
      </div>
    </main>
  );
