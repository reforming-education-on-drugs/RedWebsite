            ...
            <Row>
              {
                executiveRow.map(executive => (
                  <Col md={6}>
                    <img src={require(executive.imagePath)} className="img-circle wow fadeInDown" alt={executive.name} />
              ...
              <Row>
                {
                  advisorRow.map(advisor => (
                    <Col md={6}>
                      <img src={require(advisor.imagePath)} className="img-circle wow fadeInDown" alt={advisor.name} />
...
export default function TeamPage() {
  ...
  const executives = [
    ...
    },
    {
      name: "HASNAIEN AHMED",
      position: "CO-PRESIDENT",
      imagePath: "/assets/images/Hasnaien.jpg",
    ...
    },
    {
      ...
      imagePath: "/assets/images/Kourosh.jpg",
    ...
    },
    {
      ...
      imagePath: "/assets/images/Uriel.JPG",
    ...
    },
    {
      name: "SOPHIE OU YANG",
      position: "VP FINANCE",
      imagePath: "/assets/images/Sophie.JPG",
    ...
    },
    {
      ...
      imagePath: "/assets/images/Kaitlyn.jpg",
    ...
    },
    {
      ...
      imagePath: "/assets/images/Janna.JPG",
    ...
    },
    {
      ...
      imagePath: "/assets/images/Monica.JPG",
    ...
    },
    {
      ...
      imagePath: "/assets/images/Suman.jpg",
    ...
    },
    {
      ...
      imagePath: "/assets/images/Slobodan.JPG",
  ...
  const advisors = [
    {
      ...
      imagePath: "/assets/images/Yassine.jpg",
